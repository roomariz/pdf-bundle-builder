...
This repo includes `sample-input/` with 5 dummy PDFs generated by `scripts/generate_sample_pdfs.py`. They contain no personal or private data and are safe to use for quick testing.

Generate/regenerate them:
...
Example using the included demo PDFs:
